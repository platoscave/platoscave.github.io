    ...
    getHTMLGeometry(htmlDoc, regularFont, boldFont, monoFont, maxWidth, size, backgroundMat, borderMat, callout) {
        ...
        const makeLinesFormWords = (block, width) => {
            ...
            block.wordDescsArr.forEach((wordDesc, index) => {
                ...
                line.lineHeight = wordDesc.height * 1.2 > line.lineHeight ? wordDesc.height * 1.2 : line.lineHeight
        ...
        const printBlocks = htmlObj3d => {
            ...
            blocksArray.forEach((block) => {
                ...
                block.newLinesArr.forEach((line, lineNum) => {
                    ...
                    line.wordsArr.forEach((lineSegment, segNum) => {

                        let style = lineSegment.style
                        let segmentWidth = lineSegment.width
                        segmentX += lineSegment.spaceBeforeWidth
                        let textGeometry = lineSegment.geometry
