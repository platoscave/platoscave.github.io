...
//import fontJson from 'https://cdn.jsdelivr.net/npm/three@v0.108.0/examples/fonts/helvetiker_regular.typeface.json'
...
export default class Scene {
    ...
    constructor() {
        ...
        fontLoader.load('https://cdn.jsdelivr.net/npm/three@v0.108.0/examples/fonts/helvetiker_regular.typeface.json', (fontJson) => {
    ...
    makeLabel(text, maxWidth, size, color, backgroundColor) {
        ...
        console.log(font)
        console.log(font.data.data.boundingBox)

        var message = "Sample Test.";
    ...
    getChestahedron() {
        // see http://www.treenshop.com/Treenshop/ArticlesPages/FiguresOfInterest_Article/The%20Equilateral%20Triangle.htm
        ...
        let chestahedronObject3d = new THREE.Object3D();
        chestahedronObject3d.add(this.drawBeam(p1, p2, pipeMaterial))
        chestahedronObject3d.add(this.drawBeam(p1, p3, pipeMaterial))
        chestahedronObject3d.add(this.drawBeam(p2, p3, pipeMaterial))
        
        chestahedronObject3d.add(this.drawBeam(p1, p4, pipeMaterial))
        chestahedronObject3d.add(this.drawBeam(p2, p4, pipeMaterial))

        chestahedronObject3d.add(this.drawBeam(p2, p5, pipeMaterial))
        chestahedronObject3d.add(this.drawBeam(p3, p5, pipeMaterial))

        chestahedronObject3d.add(this.drawBeam(p1, p6, pipeMaterial))
        chestahedronObject3d.add(this.drawBeam(p3, p6, pipeMaterial))

        chestahedronObject3d.add(this.drawBeam(p4, p7, pipeMaterial))
        chestahedronObject3d.add(this.drawBeam(p5, p7, pipeMaterial))
        chestahedronObject3d.add(this.drawBeam(p6, p7, pipeMaterial))

        //let sphereGeometry = new THREE.SphereGeometry(5)
        let sphereMeshP1 = new THREE.Mesh(new THREE.SphereGeometry(5), pipeMaterial)
        sphereMeshP1.position.set(p1.x, p1.y, p1.z)
        chestahedronObject3d.add(sphereMeshP1)

        let sphereMeshP2 = new THREE.Mesh(new THREE.SphereGeometry(5), pipeMaterial)
        sphereMeshP2.position.set(p2.x, p2.y, p2.z)
        chestahedronObject3d.add(sphereMeshP2)

        let sphereMeshP3 = new THREE.Mesh(new THREE.SphereGeometry(5), pipeMaterial)
        sphereMeshP3.position.set(p3.x, p3.y, p3.z)
        chestahedronObject3d.add(sphereMeshP3)

        let sphereMeshP4 = new THREE.Mesh(new THREE.SphereGeometry(5), pipeMaterial)
        sphereMeshP4.position.set(p4.x, p4.y, p4.z)
        chestahedronObject3d.add(sphereMeshP4)

        let sphereMeshP5 = new THREE.Mesh(new THREE.SphereGeometry(5), pipeMaterial)
        sphereMeshP5.position.set(p5.x, p5.y, p5.z)
        chestahedronObject3d.add(sphereMeshP5)

        let sphereMeshP6 = new THREE.Mesh(new THREE.SphereGeometry(5), pipeMaterial)
        sphereMeshP6.position.set(p6.x, p6.y, p6.z)
        chestahedronObject3d.add(sphereMeshP6)

        let sphereMeshP7 = new THREE.Mesh(new THREE.SphereGeometry(5), pipeMaterial)
        sphereMeshP7.position.set(p7.x, p7.y, p7.z)
        chestahedronObject3d.add(sphereMeshP7)

        //var box = new THREE.BoxHelper( chestahedronObject3d, 0xffff00 );
        //chestahedronObject3d.add( box );

        return chestahedronObject3d
    ...
    drawBeam(p1, p2, material) {
        ...
        let cylinder = new THREE.CylinderGeometry(5, 5, distance, 10, 10, true)
