...
export default class Scene {
    ...
    importFont(fontName) {
        return new Promise((resolve, reject) => {
            ...
            fontLoader.load(`https://cdn.jsdelivr.net/npm/three@0.117.1/examples/fonts/${fontName}.typeface.json`,
                font => {
                    resolve(font)
                },
                xhr => {
    ...
    getHTMLGeometry(html) {
                ...
                if (node.nodeType === 1) { // Is it an Element node?
                    ...
                    switch (node.nodeName) {
                        case 'A':
                            ...
                            mergedStyle = Object.assign(parentStyle, style);
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.status == 200 && xmlhttp.readyState == 4) {
                ...
                console.log(txt)
                processChildNodes(htmlDoc.body, {})
            }
        };
