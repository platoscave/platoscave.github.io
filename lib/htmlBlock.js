...
export default class HtmlBlock {
    ...
    makeLinesFromWords() {
        ...
        this.textBlocksArr.forEach((wordDesc, index) => {
            wordDescArr.push(wordDesc)
            testLength += wordDesc.spaceBeforeWidth + wordDesc.width
        ...
        this.textBlocksArr.forEach((wordDesc, index) => {
            ...
            if (wordX > maxTextWidth) {
                ...
                lineHeight = wordDesc.height + lineSpacing * 2
                ascender = wordDesc.ascender + lineSpacing
