    ...
    applyWordWrap() {
        ...
        if (this.textAlign === 'justify') {
            linesArr.forEach((line, index) => {
                ...
                //if(!!wordDesc.text.match(/^[.,:!?]/)) lineLengthUntilNow += wordDesc.spaceBeforeWidth
                //else lineLengthUntilNow += space
        ...
        if (this.textAlign === 'center') {
            linesArr.forEach(line => {
                ...
                line.forEach(wordDesc => {
                    wordDesc.pos.x = lineLengthUntilNow
                    lineLengthUntilNow += wordDesc.width + wordDesc.spaceBeforeWidth
                })
            })
        }
