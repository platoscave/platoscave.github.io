...
export default class BCNodeObject3D extends THREE.Object3D {

    constructor(fonts, labelProps) {
        super()
        ...
        let serverObj3d = this.getServerObj3d()
        this.add(serverObj3d);

        let fibersObj3d = this.getFibersObj3d()
        this.add(fibersObj3d);
